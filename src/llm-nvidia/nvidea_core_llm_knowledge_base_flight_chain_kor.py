# ============================================================
# File: nvidea_core_llm_knowledge_base_flight_chain_kor.py
# Author: 성진
# Date: 2026-01-24
# Description:
...
#######################################################################################
## Cell 2: 사용 예시
print(get_flight_info({"first_name": "이순신", "last_name": "장군", "confirmation": 12345}))
print(get_flight_info({"first_name": "홍길동", "last_name": "의적", "confirmation": 98765}))
print(get_flight_info({"first_name": "유관순", "last_name": "열사", "confirmation": 27494}))
...
basic_chain.invoke({
    ...
    'context': get_flight_info({"first_name": "이순신", "last_name": "장군", "confirmation": 12345}),
})
